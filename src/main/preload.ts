...
contextBridge.exposeInMainWorld("api", {
  ...
  previewCardDateAllocation: call("mixed-day:preview"),
  saveCardDateAllocation: call("mixed-day:save"),
  createDailyDelivery: call("mixed-day:deliver"),
  retryDailyDeliveryReport: call("mixed-day:retry-report"),
